 ...
 */
lessonContentsRouter.patch("/:contentId",...manage,validateRequest(validateUpdateLessonContent),asyncHandler(updateController)); lessonContentsRouter.delete("/:contentId",...manage,asyncHandler(deleteController)); lessonContentsRouter.post("/:contentId/file",...manage,uploadLessonFile,asyncHandler(uploadController));
