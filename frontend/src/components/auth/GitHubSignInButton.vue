...
<template>
  <a
    :href="githubLoginUrl"
    class="flex min-h-11 w-full items-center justify-center gap-3 rounded-xl border border-slate-300 bg-slate-950 px-4 py-3 text-sm font-bold text-white shadow-sm transition hover:-translate-y-0.5 hover:bg-slate-800 focus:outline-none focus:ring-4 focus:ring-slate-300/60 dark:border-slate-600 dark:bg-white dark:text-slate-950 dark:hover:bg-slate-100"
