...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      path: "/security",
      name: "security",
      component: () => import("@/pages/student/SecurityPage.vue"),
      meta: { requiresAuth: true },
    },
    {
      path: "/my-courses",
    ...
    },
    {
      ...
      component: () => import("@/pages/student/CourseAssignmentsPage.vue"),
      meta: { requiresAuth: true, roles: [UserRole.STUDENT] },
    },
    {
      path: "/assignments/:assignmentId",
      name: "student-assignment-detail",
      component: () => import("@/pages/student/AssignmentDetailPage.vue"),
      meta: { requiresAuth: true, roles: [UserRole.STUDENT] },
    },
    {
      path: "/learn/:courseId",
      name: "learning",
      component: () => import("@/pages/student/LearningPage.vue"),
      meta: { requiresAuth: true, roles: [UserRole.STUDENT] },
    },
    {
      path: "/quiz/:quizId",
      name: "take-quiz",
      component: () => import("@/pages/student/QuizPage.vue"),
      meta: { requiresAuth: true, roles: [UserRole.STUDENT] },
    },
    {
      path: "/quiz-result",
    ...
    },
    {
      path: "/orders",
      name: "orders",
      component: () => import("@/pages/student/OrdersPage.vue"),
      meta: { requiresAuth: true, roles: [UserRole.STUDENT] },
    },
    {
    ...
    },
    {
      ...
      name: "checkout",
      component: () => import("@/pages/student/CheckoutPage.vue"),
      meta: { requiresAuth: true, roles: [UserRole.STUDENT] },
    },
    {
      path: "/payment-result/:orderId",
      name: "payment-result",
      component: () => import("@/pages/student/PaymentResultPage.vue"),
      meta: { requiresAuth: true, roles: [UserRole.STUDENT] },
    },
    {
      path: "/notifications",
    ...
    },
    {
      ...
      component: () => import("@/pages/student/CourseAnnouncementsPage.vue"),
      meta: { requiresAuth: true },
    },
    {
      path: "/courses/:courseId/announcements/:announcementId",
      name: "course-announcement-detail",
      component: () => import("@/pages/student/AnnouncementDetailPage.vue"),
      meta: { requiresAuth: true },
    },
    {
      path: "/certificates",
      name: "certificates",
      component: () => import("@/pages/student/CertificatesPage.vue"),
      meta: { requiresAuth: true, roles: [UserRole.STUDENT] },
    },
    {
      path: "/certificates/verify/:code?",
      name: "verify-certificate",
      component: () => import("@/pages/VerifyCertificatePage.vue"),
    },
    // Instructor routes
    {
      path: "/instructor/courses/:courseId/announcements",
      name: "instructor-announcements",
      component: () => import("@/pages/instructor/CourseAnnouncementsPage.vue"),
      meta: {
        requiresAuth: true,
    ...
    },
    {
      ...
      name: "course-builder",
      component: () => import("@/pages/instructor/CourseBuilderPage.vue"),
      meta: {
        requiresAuth: true,
    ...
    },
    {
      ...
      component: () => import("@/pages/instructor/AssignmentsPage.vue"),
      meta: {
        requiresAuth: true,
        roles: [UserRole.INSTRUCTOR],
      },
    },
    {
      ...
      component: () =>
        import("@/pages/instructor/AssignmentSubmissionsPage.vue"),
      meta: {
        requiresAuth: true,
        roles: [UserRole.INSTRUCTOR],
      },
