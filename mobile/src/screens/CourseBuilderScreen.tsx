...
export function CourseBuilderScreen({ route, navigation }: Props) {
  ...
  return <Screen>
    ...
    <View style={styles.builderTools}><View style={{ flex: 1 }}><Button title="Bài tập" variant="outline" onPress={() => navigation.navigate('AssignmentManager', { courseId: course.id, courseTitle: course.title })} /></View><View style={{ flex: 1 }}><Button title="Thông báo" variant="outline" onPress={() => navigation.navigate('Announcements', { courseId: course.id, courseTitle: course.title })} /></View></View>
